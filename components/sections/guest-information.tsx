                ...
                <div className="mb-3 sm:mb-4">
                  ...
                  <div className="space-y-2 sm:space-y-2.5">
                    <p className="text-xs sm:text-sm text-[#738A6E] leading-relaxed">
                      Kindly arrive by <span className="font-semibold text-[#738A6E]">8:00 AM</span> so we can begin the wedding ceremony promptly at exactly <span className="font-semibold text-[#738A6E]">8:30 AM</span>.
                    </p>
                    <p className="text-xs sm:text-sm text-[#738A6E] leading-relaxed">
