...
const timelineEvents: TimelineEvent[] = [
  ...
  },
  {
    time: "9:30 AM",
    title: "Photo Session",
    description: "Join us for group photos and candid moments to capture memories of this special day.",
    location: ceremonyVenue,
    icon: CameraIcon,
  ...
  },
  {
    ...
    description: `Welcome to the reception! Join us as ${groomNickname} & ${brideNickname} make their grand entrance and we begin the celebration.`,
  ...
  },
  {
    time: "12:30 PM",
    title: "Cake Cutting",
    description: `Join ${groomNickname} & ${brideNickname} as they cut the wedding cake together.`,
    location: receptionVenue,
    icon: CakeIcon,
