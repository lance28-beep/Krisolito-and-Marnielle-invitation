...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      `Our wedding will be held on ${siteConfig.ceremony.date} (${siteConfig.ceremony.day}) at 8:30 AM. We kindly ask guests to arrive by 8:00 AM to help us begin promptly.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      `Kindly arrive by 8:00 AM so we can begin the ceremony promptly at exactly 8:30 AM. Your punctuality means so much to us — and don't forget to have a light snack beforehand so you can enjoy the celebration comfortably!`,
  },
  {
    question: "How do I RSVP?",
    answer:
      `Please RSVP through the RSVP section on this invitation. Simply search for your name in the guest list, confirm your attendance, and let us know if you'll be bringing companions. We kindly ask for your response on or before ${siteConfig.details.rsvp.deadline} to help us prepare for the big day.`,
  },
  {
